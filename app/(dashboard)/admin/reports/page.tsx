...
export default async function AdminReportsPage() {
  ...
  const [totalReservations, approvedReservations, pendingReservations] =
    await Promise.all([
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-lg text-muted-foreground mt-2">
            Hasilkan data utilisasi ruangan yang akurat untuk mendukung
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm mt-1 leading-relaxed text-zinc-600">
              Laporan yang dihasilkan mencakup rincian lengkap setiap reservasi,
              termasuk nama pemohon, organisasi, ruangan yang dipinjam, durasi
              waktu, hingga tujuan penggunaan. Format CSV memungkinkan Anda
              untuk melakukan analisis lebih lanjut menggunakan fitur Pivot
              Table atau Chart di Microsoft Excel atau Google Sheets.
            </p>
          </div>
        </div>
      </div>
